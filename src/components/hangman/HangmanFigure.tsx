...
export const HangmanFigure: React.FC<HangmanFigureProps> = ({ incorrectGuesses }) => {
  ...
  const renderHangman = () => {
    if (incorrectGuesses === 0) {
      return (
        <svg width="200" height="250" viewBox="0 0 200 250" className="text-white">
          {/* Gallows */}
    ...
    return (
      <svg width="200" height="250" viewBox="0 0 200 250" className="text-white">
        ...
        {incorrectGuesses >= 5 && (
          <>
            <line x1="130" y1="150" x2="110" y2="180" stroke="currentColor" strokeWidth="4" />
            <line x1="130" y1="150" x2="150" y2="180" stroke="currentColor" strokeWidth="4" />
          </>
        )}
      </svg>
    );
