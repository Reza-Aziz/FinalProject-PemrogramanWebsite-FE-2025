...
import { Plus, SaveIcon, Trash2, X, EyeIcon } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                 ...
                 <div className="bg-slate-50 p-6 rounded-xl border">
                    <Typography variant="p" className="mb-2 font-bold">Settings</Typography>
                    <FormField
                        label="Initial Lives"
                        placeholder="3"
                        type="number"
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                    ...
                    <div
                        key={index}
                        className="bg-slate-50 p-4 space-y-4 rounded-xl border relative"
                    >
                        <div className="flex justify-between items-center">
                            ...
                            <Trash2
                                ...
                                className={`${
                                    ...
                                    : "text-red-500 cursor-pointer hover:bg-red-50 rounded"
                                }`}
                                onClick={() => {
